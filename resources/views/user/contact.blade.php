                        ...
                        <div class="breadcrumb-main add-contact justify-content-sm-between ">
                            <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                <div
                                    ...
                                    <h4 class="text-capitalize fw-500 breadcrumb-title">Complaints</h4>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content radius-xl">
                                            <div class="modal-header">
                                                <h6 class="modal-title fw-500" id="staticBackdropLabel">Report an Issues</h6>
                                                    ...
                                                    <form action="https://demo.jsnorm.com/">
                                                        ...
                                                        <div class="form-group mb-20">
                                                            ...
                                                            <textarea class="form-control form-control-lg" rows="3"
                                                                placeholder="Provide a detailed and comprehensive explanation of the occurrence or event."></textarea>
                                                        </div>
